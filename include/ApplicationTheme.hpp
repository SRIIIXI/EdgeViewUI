...
public:
    ...
    Q_PROPERTY(QString StandoutColor MEMBER StandoutColor_)
...
public:
    ...
    ApplicationTheme(const ApplicationTheme& other)
    {
        ...
        StandoutColor_ = other.StandoutColor_;
